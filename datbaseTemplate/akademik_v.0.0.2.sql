...
INSERT INTO `admin` (`id_admin`, `username`, `password`, `last_login`, `create_at`, `status`, `nama_admin`) VALUES
(1, 'admin', 'admin', '2024-01-02 23:02:00', '2024-01-02 13:07:04', 1, 'Wawan Julianto'),
(2, 'admin2', 'admin', '2024-01-02 23:02:25', '2024-01-02 13:07:24', 1, 'Pongalo'),
(3, 'wawan', 'admin', '2024-01-02 22:56:41', '2024-01-02 16:24:07', 1, 'Klotong');
...
INSERT INTO `dosen` (`id_dosen`, `nama_dosen`, `matakuliah`, `nid`, `ttl`, `alamat`, `avatars`, `password`, `create_at`, `last_login`, `status`) VALUES
(7, 'Wawan JUlianto', 6, 'dosen', '21323', '312313', '6594070aeadb1_136895451.png', 'admin', '2024-01-02 20:27:37', '2024-01-02 23:01:24', 1);
...
INSERT INTO `jadwal` (`id_jadwal`, `hari`, `dosen`, `ruangan`, `mulai`, `selesai`, `status`, `keterangan`) VALUES
(56, 2, 7, 1, '23:58:00', '23:59:00', 4, 'Not for today'),
(57, 3, 7, 1, '00:00:00', '00:44:00', 2, 'finished 06:15 minutes ago'),
(58, 3, 7, 1, '00:01:00', '00:03:00', 2, 'finished 06:56 minutes ago');
...
INSERT INTO `mahasiswa` (`id_mahasiswa`, `nama_mahasiswa`, `nim`, `jurusan`, `kelas`, `ttl`, `alamat`, `semester`, `avatars`, `password`, `jadwal`, `create_at`, `last_login`, `status`) VALUES
(59, 'Wawan Julianto', 'mahasiswa', 103, 1, 'aladadio , 27 juli 2003', 'Makassar', 3, '659384632ea61_658a995db1b8f.jpg', 'mahasiswa', NULL, '2024-01-02 20:29:01', '2024-01-02 23:05:14', 1),
(60, 'Wiwin Afrianti', '231000', 106, 22, 'lmabandia , 23 mei 2023', 'Maros', 6, '6593848fadfea_658aa4f0d0e7f.jpg', 'admin', NULL, '2024-01-02 20:29:01', '2024-01-02 23:05:48', 1);
...
--
ALTER TABLE `jurusan`
  MODIFY `id_jurusan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=108;
